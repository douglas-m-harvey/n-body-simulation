...
G = 1
dt_base = dt = 1E-3 # 1E-5 and lower can get very slow!
t_duration = 1
variable_step = True
...
while t_elapsed <= t_duration:
    ...
    if variable_step is True:
        # if abs(E_total[0] - E_total[t - 1]) > 40:
        #     dt = min(rad)*dt_base
        #     t -= 1
        #     print(dt)
        # else:
        #     dt = dt_base
        dt = (min(rad)*dt_base)**1.28
